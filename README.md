...
steps:
  ...
  # Install the `buf` CLI
  - uses: bufbuild/buf-setup-action@v0.9.9
...
|:---------------|:---------------------------------------------------|:-------------------|
| `version`      | The version of the [`buf` CLI][buf-cli] to install | [`v0.9.9`][version] |
...
[version]: https://github.com/bufbuild/buf/releases/tag/v0.9.9
